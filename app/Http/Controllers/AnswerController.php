...
class AnswerController extends Controller
{
    ...
    public function store(StoreRequest $request, $slug)
    {
        ...
        // ke variabel tambahkan user id
        // tambahkan jg discussion idnya berdasarkan discussion slug
        // create answer
        // jika create berhasil maka buat notif success & redirect ke detail discussion
    ...
    public function edit(string $id)
    {
        ...
        // cek apakah data answer dengan slug tersebut ada/tdk
    ...
    {
        // get answer berdasarkan id
        // cek apakah data answer dengan id tersebut ada/tdk
        // jika tidak ada maka return page not found
        // cek apakah answer ini milik user yg sedang login
        // jika bukan maka return page not found
        // get request yg sudah tervalidasi
        ...
        // jika tdk berhasil maka lanjut ke kode abort 500
