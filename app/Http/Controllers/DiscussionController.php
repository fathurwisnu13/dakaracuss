...
class DiscussionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // return page index beserta dengan datanya
        // data yg dipass ke view adalah discussion yg sudah disort dgn created at menurun
        // pagination per 10/20
        // data semua category
    ...
    public function store(StoreRequest $request)
    {
        ...
        // jika tidak masukkan content tersebut ke content preview tanpa + '...'
        ...
        // jika tidak maka kembalika error 500
        ...
        if ($create) {
            session()->flash('notif.success', 'Discussion create successfully!');
    ...
    {
        // dapatkan discussion berdasarkan slug dan eager load user & category
        // cek apakah data discussion dengan slug tersebut ada/tdk
        // jika tidak ada maka return page not found
        // get aswer berdasarkan discussion id
        // sort berdasarkan created at menurun
        // paginate 5
        // get semua category
        // lalu return response
    ...
    public function edit(string $slug)
    {
        ...
        // jika bukan maka return pake not found
        // return view dgn discussion dan category
    ...
    public function destroy(string $slug)
    {
        ...
        // jika tidak berhasil maka lajut ke kodingan di bawahnya yakni return error 500
