...
<section class="container min-h-372px">
  <div class="row">
    ...
    <div class="col-12 col-lg-4 text-center">
      <img class="promote-icon mb-2" src=" {{ url('assets/images/users.png') }}" alt="Answers">
      <h2>Users</h2>
      <p class="fs-3">5123</p>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-5 col-lg-7">
                <div class="avatar-sm-wrapper d-inline-block">
                  <a href="#" class="me-1">
                    <img src=" {{ url('assets/images/avatar-sm.png')}}" class="avatar rounded-circle" alt="dummy avatar">
                  </a>
                </div>
                <span class="fs-12px">
                  <a href="#" class="me-1 fw-bold">fathurwm</a>
