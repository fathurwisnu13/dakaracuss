        ...
        <div class="row">
            <div class="col-12 col-lg-4 mb-5 mb-lg-0">
                <div class="d-flex mb-4">
                    ...
                    <div>
                        <div class="mb-4">
                            <div class="fs-2 fw-bold mb-1 1h-1 text-break">
                                fathurwm
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5 col-lg-4">
                                            <div class="avatar-sm-wrapper d-inline-block">
                                                <a href="#" class="me-1" >
                                                    <img src=" {{ url('assets/images/avatar-sm.png') }}" alt="fathurwm" class="avatar rounded-circle">
                                                </a>
                                            </div>
                                            <span class="fs-12px">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <span class="fw-bold text-primary">
                                        <a href="#">
                                            How to add a costum validation in Laravel
                                        </a>
                                    </span>
                                </div>
                            </div>
