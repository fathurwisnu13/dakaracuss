    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6 mb-5 mb-lg-0">
          <img src="{{ url('assets/images/logo.png')}}" alt="logo daracuss" class="h-32px mb-4">
          <p class="text-white">Empowering the Security community <br/> to connect, share and learn</p>
        </div>
          ...
          <div class="d-flex flex-column flex-lg-row justify-content-end">
            <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
              ...
              <ul class="list-unstyled">
                <li class="text-white"> <a href="mailto:hi@daracuss.com">hi@daracuss.com</a></li>
              </ul>
            </div>
